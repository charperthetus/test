...
Ext.define('Savanna.itemView.view.itemView.Toolbar', {
    extend: 'Ext.toolbar.Toolbar',
    alias: 'widget.itemview_toolbar',
    ...
    buildFormatMenuItems: function() {
        ...
        return [
            ...
            {
                type: 'nodeType submenu',
                text: 'Node Type',
                menu: {xtype: 'crumbnet_part_nodeTypeMenu', itemId: 'nodeTypeMenu' }
            },
            {
