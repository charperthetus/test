...
Ext.define('Savanna.process.utils.ViewTemplates', {
    ...
    makeDecisionGadget: function () {
        var gmake = go.GraphObject.make;
        return gmake(go.Panel, go.Panel.Auto, this.styler().decisionGadget({
    ...
    makeAdornment: function (alignmentSpot, gooPoint, gooAngle, dropHandler, clickHandler, glyph, labelStr, labelPoint) {
        ...
        var gmake = go.GraphObject.make;
        return gmake(go.Panel, go.Panel.Position, this.styler().adornments({
            ...
            gmake(go.Shape,
        {
            ...
            gmake(go.TextBlock, labelStr, this.styler().adornments({
            "position": labelPoint
        }).label));
    },
    ...
    generateGroupTemplateMap: function () {
...

        {
            ...
            position: new go.Point(10, 8),
            stroke: null
        }, 'Results', new go.Point(25, 58)))); // end Actions Group
        ...
        gmake('PanelExpanderButton'),
            ...
            this.makeTopPort(),
            this.makeStepGadget(),
            this.makeDecisionGadget())); // end AltsGroup
