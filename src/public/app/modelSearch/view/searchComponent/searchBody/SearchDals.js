...
Ext.define('Savanna.modelSearch.view.searchComponent.searchBody.SearchDals', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.model_search_searchdals',
    ...
    initComponent: function () {
        ...
        Savanna.controller.Factory.getController('Savanna.modelSearch.controller.SearchDals');
    },
    ...
    createPanel: function(myRecord) {
        return Ext.create('Savanna.modelSearch.view.searchComponent.searchBody.searchDals.SearchOptions', {
