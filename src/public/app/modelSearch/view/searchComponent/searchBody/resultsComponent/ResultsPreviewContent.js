...
Ext.define('Savanna.modelSearch.view.searchComponent.searchBody.resultsComponent.ResultsPreviewContent', {
    extend: 'Ext.panel.Panel',
    controller: 'Savanna.modelSearch.controller.resultsComponent.ResultsPreviewContentController',
    alias: 'widget.model_search_resultspreviewcontent',
    header: false,
