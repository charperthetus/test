Ext.define('Savanna.modelSearch.model.DalSource', {
    ...
    fields: [
        ...
        // These are fields used to filter result sets
    ...
    associations: [
        {
            ...
            model: 'Savanna.modelSearch.model.dalSource.CustomSearchDescription',
