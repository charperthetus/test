 ...
 */
Ext.define('Savanna.modelSearch.model.dalSource.CustomSearchDescription', {
    ...
    hasMany: [
        { model: 'Savanna.modelSearch.model.dalSource.CustomSearchGroup', name: 'customSearchGroups' }
    ]
});
