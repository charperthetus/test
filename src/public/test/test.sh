...
if [[ $COMMAND == "start" ]]; then
	...
	java -jar ~/.m2/repository/com/github/tntim96/JSCover/0.3.0/JSCover-0.3.0.jar -ws --document-root=public --report-dir=public/test/reports --no-instrument-reg=ext --no-instrument-reg=test > $ROOTDIR/jscover.out 2> $ROOTDIR/jscover.err < /dev/null &
