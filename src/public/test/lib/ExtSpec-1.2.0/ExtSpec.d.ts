...
module ExtSpec {
    /**
    * Wraps the browser console in a mutable object.
    */
    ...
    */
    class ResourceConfig {
        ...
        */
        constructor(property: string, suffix?: string, matcher?: (list: any, value: any) => bool, itemProperty?: string);
        public property: string;
        public suffix: string;
        public matcher: (list: any, value: any) => bool;
    ...
    * @returns {Boolean}
    */
    function isTypeOf(value: any, compare: string): bool;
    /**
    * Returns true if a given value is an object type and is not null, otherwise false.
    * @param {Object} value Any value of any type.
    * @returns {Boolean}
    */
    function isObjectType(value: any): bool;
    /**
    ...
    * @returns {Boolean}
    */
    function objectKeysMatch(value: any, match: any): bool;
    /**
    * Copies properties to the destination object from the source.
    * @param {Object} destination The destination object.
    * @param {Object} source The source object.
    */
    function apply(destination: any, source: any): void;
    /**
    ...
    */
    ...
    /**
    * Marks a method as obsolete and logs it to the console.
    * @param {Object} arg The method configuration argument.
    */
...
module ExtSpec.ClassManager {
    ...
    * @returns {Function}
    */
    function construct(className: string): any;
    /**
...
module ExtSpec {
    var create: (className: any) => any;
}
/**
* Mock Ext module.
*/
module Ext {
    function define(className: string, configuration: any, callback?: Function): any;
}
/**
...
module ExtSpec.Jasmine {
    ...
    */
    ...
    /**
    * Fetches the return value assigned to a spy. For example:
    * ExtSpec.Jasmine.getSpyReturn(Ext, 'fly.createChild.getBox'
...
module ExtSpec.Jasmine.Matchers {
    ...
    * @returns {Boolean}
    */
    function toHaveBeenCalledWithConfig(expected: any, arg?: number): bool;
    /**
    * Passes if the spy added a listener for the given event name.
    * @param {String} expected The event name to match.
    * @returns {Boolean}
    */
    function toHaveAddedListener(expected: string): bool;
    /**
    ...
    * @returns {Boolean}
    */
    function toHaveAddedListener(expected: IListenedConfig): bool;
    /**
    * Passes if the spy removed a listener for the given event name.
    * @param {String} expected The event name to match.
    * @returns {Boolean}
    */
    function toHaveRemovedListener(expected: string): bool;
    /**
    * Passes if the spy removed a listener for the given event configuration.
    * @param {Object} expected The event configuration to match.
    * @returns {Boolean}
    */
    function toHaveRemovedListener(expected: IListenedConfig): bool;
    /**
    * Passes if the spy added a listener for the given event name.
    * @param {String} expected The event name to match.
    * @returns {Boolean}
    */
    function toHaveAddedManagedListener(expected: string): bool;
    /**
    * Passes if the spy added a listener for the given event configuration.
    * @param {Object} expected The event configuration to match.
    * @returns {Boolean}
    */
    function toHaveAddedManagedListener(expected: IListenedConfig): bool;
    /**
    * Passes if the spy removed a listener for the given event name.
    * @param {String} expected The event name to match.
    * @returns {Boolean}
    */
    function toHaveRemovedManagedListener(expected: string): bool;
    /**
    * Passes if the spy removed a listener for the given event configuration.
    * @param {Object} expected The event configuration to match.
    * @returns {Boolean}
    */
    function toHaveRemovedManagedListener(expected: IListenedConfig): bool;
    /**
    * Passes if the spy controlled the given event name.
    * @param {String} expected The event name to match.
    * @returns {Boolean}
    */
    function toHaveControlled(expected: string): bool;
    /**
    * Passes if the spy controlled the given event configuration.
    * @param {Object} expected The configuration to match.
    * @returns {Boolean}
    */
    function toHaveControlled(expected: IControlledConfig): bool;
}
/**
* Obsolete matchers for Jasmine.
*/
module ExtSpec.Jasmine.Matchers {
    function toHaveBoundEvent(event: string, expected: Function, call?: number): bool;
    function toHaveBoundEvent(event: string, expected: string, call?: number): bool;
    function toHaveUnboundEvent(event: string, expected: Function, call?: number): bool;
    function toHaveUnboundEvent(event: string, expected: string, call?: number): bool;
    function toHaveControlledEvent(event: string, expected: Function, selector?: string, call?: number): bool;
    function toHaveControlledEvent(event: string, expected: string, selector?: string, call?: number): bool;
}
