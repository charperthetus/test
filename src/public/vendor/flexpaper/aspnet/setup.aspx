			...
			<form class="devaldi" action="setup.aspx" method="post" onsubmit="return validateConfiguration()">
				...
				<table width="100%" cellspacing="0" cellpadding="0" class="sortable">
						...
						<tr>
                            ...
                            <td>
                                    <INPUT TYPE=RADIO NAME="SPLITMODE" id="SPLITMODE1" VALUE="false" checked="true" style="vertical-align: middle"> No
                                    <INPUT TYPE=RADIO NAME="SPLITMODE" id="SPLITMODE2"VALUE="true" style="vertical-align: middle;margin-left:30px;"> Yes<BR>
				...
				<script language="JavaScript">
				    ...
				    function checkDirectoryPermissions(obj) {
				        var infield = obj;
				        var swftoolscheck = "";
				        if (obj.attr('id') == "PUBLISHED_PDF_DIR") { swftoolscheck = "&pdfdir=" + $("input#PDF_DIR").val() + "&swftoolsdir=<%=Server.UrlEncode(path_to_pdf2swf) %>"; }
				        if (infield.val().length < 3) { return; }
				        $.ajax({
				            url: "checkdirpermissions.aspx?dir=" + infield.val() + swftoolscheck,
